...
/**
 *  Mock HeaderCredentialsClient class.
 */
class HeaderCredentialsClient
{
    /**
     * @var string
     */
     ...
     */
    private function getCredentials(): HeaderCredentials
    {
        ...
        return new HeaderCredentials($apiKeys['secret']);
    }
