...
namespace MauticPlugin\LiveStormBundle\Sync\Mapping\Manual;
...
{
    public const LIVESTORM_OBJECT = 'participant';
    /**
    ...
    public function getManual(): MappingManualDAO
    {
        ...
        $this->manual = new MappingManualDAO(LiveStormIntegration::NAME);

        $this->configureObjectMapping(self::LIVESTORM_OBJECT);
